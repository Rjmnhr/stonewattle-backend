...
const DomainInsights = {
  filter: (filter, callback) => {
    ...
    ,CAST(great_for_schools AS UNSIGNED) AS great_for_schools_int, CAST(great_for_medical_facilities AS UNSIGNED) AS great_for_medical_facilities_int, CAST(great_for_public_transport AS UNSIGNED) AS great_for_public_transport_int,
